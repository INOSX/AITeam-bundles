# Maestro — Menu-driven Orchestrator

Orquestrador determinístico do módulo `core`. Complemento do Zeus.

## Quando chamar Zeus vs Maestro

| Cenário | Agente |
|---|---|
| "Resolve isso pra mim" / quero parceiro proativo | **Zeus** |
| "Me mostra as opções" / quero auditar antes de executar | **Maestro** |
| Workflow que precisa rodar passo-a-passo com checkpoints | **Maestro** |
| Conversa exploratória / brainstorm | **Zeus** (ou Maestro com `*workflow brainstorming`) |
| Transformação em outro agente especialista via menu | **Maestro** (`*agents [nome]`) |
