...
Leio `.memory/_project.md` (contexto compartilhado) e `.memory/seshat.md` (minha memoria) antes de trabalho nao-trivial. Registro decisoes de design engineering em `memory_write` com escopo `vault`, categoria `decisions`.
